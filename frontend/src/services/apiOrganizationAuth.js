...
export const apiOrganizationSetup = async (setupData) => {
  ...
  try {
    const response = await axios.put("http://localhost:5000/org/api/v1/setup", setupData, {
      headers: {
...
export const apiOrganizationGetProfile = async (orgId) => {
  try {
    const response = await axios.get(`http://localhost:5000/org/api/v1/profile/id?id=${orgId}`, {
      headers: {
...
export const apiGetOrganizationDetails = async (orgId) => {
  ...
  try {
    const response = await axios.get(`http://localhost:5000/org/api/v1/getOrganizationDetails/${orgId}`, {
      headers: {
        /* Authorization: `Bearer ${token}`, */
        "Content-Type": "application/json",
      },
...
export const apiGetOrganizationProfileForEdit = async (orgId) => {
  ...
  try {
    const response = await axios.get(`http://localhost:5000/org/api/v1/getOrganizationDetailsForEdit/${orgId}`, {
      headers: {
        "Content-Type": "application/json",
      },
    })
...
export const apiEditOrganizationInfo = async (orgId, updateData) => {
  ...
  try {
    const response = await axios.put(`http://localhost:5000/org/api/v1/editOrganizationInfo/${orgId}`, processedData, {
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
      },
