...
export default function VacancyCard({deadline,views,vacancyTitle,vacancyCompany,skills=[]}) {
/*   const deadline = "1 week, 3 days from today";
  const views = "500";
  const vacancyTitle = "Primary Level Teacher";
  const vacancyCompany = "Gita Mata School";
  const skills = ["Communication", "Motivation", "Supervison"]; */
