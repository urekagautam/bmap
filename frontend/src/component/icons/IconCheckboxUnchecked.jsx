...
const IconCheckboxUnchecked = ({ className = "", ...props }) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props} className={cns("icon", className)}>
    <path
